...
public class DoctorPatient implements DoctorPatientInterface{
...
String doctId="";
{
	try {
	    ...
	    appointmentlist=mapper.readValue(new File("/home/admin1/Documents/ClinicData/appointment.json"), new TypeReference<List<Appointment>>() {});
	}
	catch(Exception e)
	{
	...
	public void addPatient()
	{
	   ...
	   Patient temp=new Patient(patientId,patientName,mobno,age); {
...
try
{
	mapper.writeValue(new File("/home/admin1/Documents/ClinicData/doctor.json"), doctorlist);
	mapper.writeValue(new File("/home/admin1/Documents/ClinicData/patient.json"), patientlist);
	mapper.writeValue(new File("/home/admin1/Documents/ClinicData/appointment.json"), appointmentlist);
}
catch(Exception e)
{
	e.printStackTrace();
...
public void appointment()
{
	...
	//Doctor temp=doctorlist.get(i);
		Doctor temp=(Doctor)doctorlist.stream().filter(i ->i.getDoctorId().equals(id)).collect(Collectors.toList()).get(0);
		...
		appointmentlist.add(new Appointment(id,dname,pname,patientid,mobno,available));
